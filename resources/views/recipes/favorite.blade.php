    ...
    <div class="container my-20">
        <div class="row">
            ...
            <p class="text-xl mb-4">
                "Tinh tế biến hóa, tạo nên sự khác biệt. Công thức của người, trở thành cảm xúc riêng ta."
            </p>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            deleteButtons.forEach(function (button) {
                button.addEventListener('click', function () {
                    ...
                    modal.querySelector('.modal-title').textContent = 'Are you sure you want to remove "' + recipeTitle + '"from your favorite list ?';
                    var form = document.getElementById('deleteForm');
                    form.action = 'favorite/destroy/' + recipeId;
